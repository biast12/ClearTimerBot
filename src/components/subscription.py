...
class InvalidTimerView(discord.ui.LayoutView):
    ...
    def __init__(self, error_message: str, translator):
        ...
        content = add_footer(translator.get("errors.invalid_timer", timer=error_message))
...
class UnsubscribeSuccessView(discord.ui.LayoutView):
    ...
    def __init__(self, channel: discord.TextChannel, translator):
        ...
        content = add_footer(translator.get("commands.subscription.remove.success", channel=channel.mention))
...
class ChannelNotSubscribedView(discord.ui.LayoutView):
    ...
    def __init__(self, channel: discord.TextChannel, translator):
        ...
        content = add_footer(translator.get("commands.subscription.info.not_subscribed").replace("{channel}", channel.mention))
...
class InvalidTargetView(discord.ui.LayoutView):
    ...
    def __init__(self, translator):
        ...
        content = add_footer(translator.get("errors.invalid_target"))
...
class NoSubscriptionDataView(discord.ui.LayoutView):
    ...
    def __init__(self, channel: discord.TextChannel, translator):
        ...
        content = add_footer(translator.get("components.no_data", channel=channel.mention))
...
class JobNotFoundView(discord.ui.LayoutView):
    ...
    def __init__(self, channel: discord.TextChannel, translator):
        ...
        content = add_footer(translator.get("errors.job_not_found", channel=channel.mention))
...
class NextTimeNotFoundView(discord.ui.LayoutView):
    ...
    def __init__(self, channel: discord.TextChannel, translator):
        ...
        content = add_footer(translator.get("errors.next_time_not_found", channel=channel.mention))
