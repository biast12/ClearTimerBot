...
class BlacklistErrorView(discord.ui.LayoutView):
    ...
    def __init__(self, translator):
        ...
        content = add_footer(
            translator.get("validation.blacklisted_detailed"), translator
        )
...
class PermissionErrorView(discord.ui.LayoutView):
    ...
    def __init__(
        ...
        if channel:
            content = add_footer(
                translator.get(
                    "validation.bot_missing_permissions_detailed",
            ...
            content = add_footer(
                translator.get(
                    "validation.insufficient_permissions_detailed",
                    permissions=missing_permissions,
                ),
                translator,
            )
...
class SubscriptionStatusErrorView(discord.ui.LayoutView):
    ...
    def __init__(self, channel: discord.TextChannel, is_subscribed: bool, translator):
        ...
        if is_subscribed:
            content = add_footer(
                translator.get(
                    "validation.channel_already_subscribed_detailed",
                    channel=channel.mention,
                ),
                translator,
            )
